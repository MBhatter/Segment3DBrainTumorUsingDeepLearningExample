...
tempLayers = [
    concatenationLayer(3,2,"Name","concat_7")
...
lgraph = connectLayers(lgraph,"conv_Module1_Level1","concat_1/in1");
lgraph = connectLayers(lgraph,"conv_Module1_Level2","concat_1/in2");
...
lgraph = connectLayers(lgraph,"conv_Module2_Level1","concat_2/in1");
lgraph = connectLayers(lgraph,"conv_Module2_Level2","concat_2/in2");
...
lgraph = connectLayers(lgraph,"conv_Module3_Level1","concat_3/in1");
lgraph = connectLayers(lgraph,"conv_Module3_Level2","concat_3/in2");
...
lgraph = connectLayers(lgraph,"conv_Module4_Level1","concat_4/in1");
lgraph = connectLayers(lgraph,"conv_Module4_Level2","concat_4/in2");
...
lgraph = connectLayers(lgraph,"conv_Module5_Level1","concat_5/in1");
lgraph = connectLayers(lgraph,"conv_Module5_Level2","concat_5/in2");
...
lgraph = connectLayers(lgraph,"conv_Module6_Level1","concat_6/in1");
lgraph = connectLayers(lgraph,"conv_Module6_Level2","concat_6/in2");
...
lgraph = connectLayers(lgraph,"conv_Module7_Level1","concat_7/in1");
lgraph = connectLayers(lgraph,"conv_Module7_Level2","concat_7/in2");
